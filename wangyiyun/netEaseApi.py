...
if __name__ == '__main__':
    #help(netease)
    # print(netease.login("15074816863", "15074816863"))
    #netease.user_playlist("1541194463")
    #print(netease.all_playlist())
   # print(netease.details_playlist("2978252207"))
    #print(netease.search("蔡依林"))
    #print(netease.singsUrl(["2978252207"]))
    print(netease.newsong())
    #print(netease.fnewsong())
    #print(netease.getContainedPlaylists('210042'))
